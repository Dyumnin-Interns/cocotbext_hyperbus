...
///////////////////////////////////////////////////////////////////////////////
    ...
    begin
                ...
                begin
                    ...
                    begin
                        ...
                        begin
                            ...
                            // $display("[%t]  Read %h Addr: %h",$time,Dout_zd_tmp,Address);
                        end
                        else // reg
                                ...
                                begin
                                    ...
                                    begin
                                        ...
                                        begin
                                            ...
                                            if (data_cycle % 2 == 0)
                                            begin
                                                // $display("[%t] LbyteMask: %b \t Ubytemask: %b",$time,LByteMask,UByteMask);
                                                if (!LByteMask) begin
                                                    // $display("........Inside Lbytemask");
                                                    Mem[Address][7:0]=Data_in[7:0];
                                                end

                                                if (!UByteMask) begin
                                                    // $display("........Inside Ubytemask");
                                                    Mem[Address][15:8]=Data_in[15:8];
                                                end

                                                
                                            end
                                            // $display("[%t]  Write %h  addr: %h ",$time,Mem[Address], Address);
                                        end
                                    end
                                end
        ...
        begin//https://github.com/Wren6991/HyperRam.git
